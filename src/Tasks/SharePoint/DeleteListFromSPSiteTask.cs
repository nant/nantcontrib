...
namespace NAnt.SharePoint.Tasks
{
	...
	/// <remarks>
	///   <para>
	///   Deletes a SPList from the identified SPWeb by <see cref="WebUrl"/> on 
	...
	///   </code>
	/// </example>
	[TaskName("deletelistfromspsite")]
	public class DeleteListFromSPSiteTask: Task {
		...
		/// <summary>
		/// Task for deleting a SPRole from a site.
		/// </summary>
		protected override void ExecuteTask() {       
			...
			try {
				...
				throw new BuildException( 
					string.Format("Cannot delete list: {0} from site: {1}.", 
