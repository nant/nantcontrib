...
namespace NAnt.Contrib.Tasks.PVCS {
	...
	/// <example>
	/// <para>
	/// Adds <c>File1.txt</c> and <c>File2.txt</c> to the root level of the project database specified by the
	...
	/// <example>
	/// <para>
	/// Adds <c>File1.txt</c> and <c>File2.txt</c> to the <c>folder</c> project of the project database specified by
	...
	/// <example>
	/// <para>
	/// Adds <c>another_file.txt</c> and all files and folders at and below <c>C:\Data</c> to the project database
	/// specified by the <c>project-database</c> property.
	/// </para>
	/// <code>
	/// <![CDATA[
