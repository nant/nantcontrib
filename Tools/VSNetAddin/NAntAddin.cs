...
namespace NAnt.Contrib.NAntAddin
{
	...
	public class Addin : IDTExtensibility2, IDTCommandTarget
	{
		...
		private void CreateBuildOutputWindow()
		{
			...
			Log.Listeners.Add(new AddinLogListener(buildOutputWindow));
		}
	...
	/// </summary>
	internal class AddinLogListener : LogListener
	{
		...
		{
			buildOutputWindow.OutputString(message);
		}
	...
	internal class BuildExecutor
	{
		...
		public void Run()
		{
			...
			SourceForge.NAnt.Project nAntProject = 
				new SourceForge.NAnt.Project(project.FileName);

			nAntProject.Verbose = project.Verbose;
			...
			catch (SourceForge.NAnt.BuildException be)
			{
				buildOutputWindow.Activate();
				buildOutputWindow.OutputString("\n" + be.Message);
