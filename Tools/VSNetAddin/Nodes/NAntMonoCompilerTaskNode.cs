...
namespace NAnt.Contrib.NAntAddin.Nodes {
    /// <summary>
    /// Tree Node that represents an NAnt mono task.
    /// </summary>
    /// <remarks>None.</remarks>
    [NAntTask("mcs", "Compile a C# Program with Mono's Compiler", "csharptask.bmp")]
    public class NAntMonoCompilerTaskNode : NAntTaskNode {
        /// <summary>
        /// Creates a new <see cref="NAntMonoCompilerTaskNode"/>.
        /// </summary>
        /// <param name="TaskElement">The task's XML element.</param>
        /// <param name="ParentElement">The parent XML element of the task.</param>
        /// <remarks>None.</remarks>
        public NAntMonoCompilerTaskNode(XmlElement TaskElement, XmlElement ParentElement) 
